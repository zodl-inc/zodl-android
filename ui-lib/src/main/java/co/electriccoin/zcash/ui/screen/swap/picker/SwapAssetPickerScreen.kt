...
data class SwapAssetPickerArgs(
    ...
    /**
     * When set, the picker sources assets from that provider's repository and offers only its assets (the
     * NEAR-only Pay flow passes NEAR). Null uses the aggregator across all providers.
     */
