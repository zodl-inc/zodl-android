...
class MayaSwapDataSource(
    ...
    /**
     * Maya's "do not broadcast after" deadline as returned by `/v3/swap`, or null when absent so the caller
     * falls back to the measured route TTL. Epoch values above 1e12 are read as milliseconds, else as seconds.
     */
