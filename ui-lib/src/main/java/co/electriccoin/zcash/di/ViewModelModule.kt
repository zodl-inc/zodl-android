...
val viewModelModule =
    module {
        ...
        viewModel {
            ...
            SwapVM(
                getCuratedSwapAssetsUseCase = get { parametersOf(swapRepository) },
        ...
        viewModel {
            ...
            PayVM(
                getCuratedSwapAssetsUseCase = get { parametersOf(nearRepository) },
                getSelectedWalletAccount = get(),
        ...
        viewModel { (args: SwapBlockchainPickerArgs) ->
            SwapBlockchainPickerVM(
                getCuratedSwapAssets = get { parametersOf(get<SwapRepository>()) },
                args = args,
