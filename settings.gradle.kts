...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("androidx-biometric-ktx", "androidx.biometric:biometric-ktx:1.4.0-alpha02")
            ...
            library("firebase-crashlytics", "com.google.firebase", "firebase-crashlytics").withoutVersion()
